...
export class RulesService {
  ...
  // ===========================================================
  // 🔵 CHECK CIRCULATION (Day or Week) - CON LOGS
  // ===========================================================
  async checkCirculation(
    ...
    user?: string, // Usuario opcional desde el request
  ) {
    // ----------------------------
    ...
    if (fullWeek) {
      ...
      // Registrar log de consulta semanal
      await this.logsService.create({
        user: user || 'anonymous',
        method: 'POST',
        endpoint: '/rules/week',
